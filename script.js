(function() {
  ...
  class SolarGrid {
    ...
    updateSize() {
  		...
  		const gridWrapper = this.wrapper.closest('.grid-container') || this.wrapper.parentElement;
  		const maxWidth = gridWrapper.clientWidth - 100; // 100% des Grid-Wrappers - 100px für Buttons
